...
//
    ...
    public void testTreeSpanningBackwardsIterator()
    {
        ...
        assertEquals(10, resultList1.size());
        assertSame(nodeB3, resultList1.get(0));
        assertSame(nodeC6, resultList1.get(1));
        assertSame(nodeC5, resultList1.get(2));
        assertSame(nodeC4, resultList1.get(3));
        assertSame(nodeB2, resultList1.get(4));
        assertSame(nodeC3, resultList1.get(5));
        assertSame(nodeC2, resultList1.get(6));
        assertSame(nodeC1, resultList1.get(7));
        assertSame(nodeB1, resultList1.get(8));
        assertSame(nodeA, resultList1.get(9));
