...
public class SlicerTask extends Task<SliceResult>
{
    ...
    protected SliceResult call() throws Exception
    {
        ...
        if (osName.equals("Windows 95"))
        {
            ...
            commands.add("/S");
            commands.add("/C");
            commands.add("\"\"" + ApplicationConfiguration.getApplicationInstallDirectory(CoreTest.class) + "RoboxSlic3r\\bin\\slic3r.exe\" --load \"" + configFile + "\" -o \"" + tempGcodeFilenameWithPath + "\" \"" + tempModelFilenameWithPath + "\"\"");
        ...
        {
            commands.add(ApplicationConfiguration.getApplicationInstallDirectory(CoreTest.class) + "RoboxSlic3r/bin/slic3r");
            commands.add("--load");
