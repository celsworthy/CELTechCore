...
public enum FirmwareError
{
    ...
    ERROR_BED_THERMISTOR("error.ERROR_BED_THERMISTOR", 22, OK_ABORT),
    ERROR_NOZZLE0_THERMISTOR("error.ERROR_NOZZLE0_THERMISTOR", 23,OK_ABORT),
    ERROR_NOZZLE1_THERMISTOR("error.ERROR_NOZZLE1_THERMISTOR", 24, OK_ABORT),
