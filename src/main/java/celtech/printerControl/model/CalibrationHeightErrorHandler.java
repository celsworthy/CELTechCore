...
/**
 * The CalibrationHeightErrorHandler listens for printer errors and if they occur then the next call
 * to {@link #checkIfPrinterErrorHasOccurred()} will cause the user to get an Abort dialog, which is
 * followed by raising an exception.
 *
 * @author tony
 */
class CalibrationHeightErrorHandler
{
    ...
    public CalibrationHeightErrorHandler(Printer printer, Cancellable cancellable)
    {
