...
//        parentGroup.getChildren().add(heightUpArrowHead);

        heightDownArrowHead = createArrowHead(ArrowHeadDirection.DOWN);
//        parentGroup.getChildren().add(heightDownArrowHead);
...
//        parentGroup.getChildren().add(widthLeftArrowHead);
//
//        widthRightArrowHead = createArrowHead(ArrowHeadDirection.RIGHT);
//        parentGroup.getChildren().add(widthRightArrowHead);
//
//        depthBackArrowHead = createArrowHead(ArrowHeadDirection.BACK);
//        parentGroup.getChildren().add(depthBackArrowHead);
//
//        depthForwardArrowHead = createArrowHead(ArrowHeadDirection.FORWARD);
//        parentGroup.getChildren().add(depthForwardArrowHead);
    }
