 ...
 */
public class PrinterStatusSidePanelControllerWithTargetTempsXXX implements Initializable, SidePanelManager
{
    ...
    @FXML
    private GridPane targetTemperatureGrid;
    ...
    public void initialize(URL url, ResourceBundle rb)
    {
        ...
        targetTemperatureGrid.setVisible(false);
...
//                    headNotAttachedString)));
    ...
    private void unbindSelectedPrinter()
    {
        ...
        bedHeaterCheckBox.selectedProperty().removeListener(bedHeaterCheckBoxListener);
        nozzleHeaterCheckBox.selectedProperty()
