...
//                String targetVariableName = extractTargetVariableName(entry.getValue());
                ...
                try
                {
                    getMethod = getVariableMethod(methodName);
                ...
                {
                    steno.warning("Failed to get method: " + methodName + " variable: " + targetVariableName);
                }
            }
    ...
    {
        String altMethodName = "get" + methodName.substring(0, 1).toUpperCase() + methodName.substring(1, methodName.length());
