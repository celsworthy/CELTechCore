...
import celtech.utils.threed.importers.svg.metadata.svg.SVGClosePath;
import celtech.utils.threed.importers.svg.metadata.svg.SVGEndPath;
import celtech.utils.threed.importers.svg.metadata.svg.SVGMetaCubicBezier;
import celtech.utils.threed.importers.svg.metadata.svg.SVGMetaLine;
import celtech.utils.threed.importers.svg.metadata.svg.SVGMetaLineHorizontal;
import celtech.utils.threed.importers.svg.metadata.svg.SVGMetaLineVertical;
import celtech.utils.threed.importers.svg.metadata.svg.SVGMetaMove;
import celtech.utils.threed.importers.svg.metadata.svg.SVGMetaPart;
import celtech.utils.threed.importers.svg.metadata.svg.SVGMetaUnhandled;
import celtech.utils.threed.importers.svg.metadata.svg.SVGStartPath;
...
public class PathParserThing implements PathHandler
{
    ...
    private final List<SVGMetaPart> metaparts = new ArrayList<>();
    ...
    {
        metaparts.add(new SVGMetaMove(x, y, false));
    }
